import cv2
import numpy as np
from services.skeleton.modules.keypoints import BODY_PARTS_KPT_IDS, BODY_PARTS_PAF_IDS
from services.skeleton.modules.one_euro_filter import OneEuroFilter
class Pose:
    num_kpts = 18
    kpt_names = ['nose', 'neck',
