import time
import itertools
from utility.anime_utility.photo2cartoon.dataset import ImageFolder
from torchvision import transforms
from torch.utils.data import DataLoader
from .networks import *
from utility.anime_utility.photo2cartoon.utils import *
...
class UgatitSadalinHourglass(object):
    ...
    def build_model(self):
        ...
        self.facenet = FaceFeatures(settings.ANIME_MODEL.MODEL_MOBILEFACE_NET, self.device)
