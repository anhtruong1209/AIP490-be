...
from application.main.utility.face_smooth_utility.utils import image
from application.main.config import settings

def detect_face(net, input_img):
    """
    ...
    blob = cv2.dnn.blobFromImage(input_img, 
                                 1.0, 
                                 settings.SMOOTH_FACE_CONFIG.SIZE, 
                                 settings.SMOOTH_FACE_CONFIG.MEAN, 
                                 False, 
                                 False)
    ...
    for i in range(detections.shape[2]):
        ...
        conf_threshold = settings.SMOOTH_FACE_CONFIG.CONF_THRESHOLD
